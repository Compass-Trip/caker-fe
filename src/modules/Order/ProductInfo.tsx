  ...
  return (
    <div className="flex flex-col gap-6 py-4">
      <div className="flex flex-col gap-2">
        ...
        <div className="mx-4 w-[351px] bg-[#FFEAEF] rounded-[12px] px-[14px] py-2  text-[15px] leading-[22px] tracking-[0.0096em] text-[#2D2A32]">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="mx-4 w-[351px] bg-[#EDFEE8] rounded-[12px] px-[14px] py-2 text-[15px] leading-[22px] tracking-[0.0096em] text-[#2D2A32] space-y-2">
